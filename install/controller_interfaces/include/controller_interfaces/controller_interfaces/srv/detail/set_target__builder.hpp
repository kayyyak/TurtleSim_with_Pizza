...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::controller_interfaces::srv::SetTarget_Response result(::controller_interfaces::srv::SetTarget_Response::_result_type arg)
  {
...
private:
  ::controller_interfaces::srv::SetTarget_Response msg_;
};
...
{
  return controller_interfaces::srv::builder::Init_SetTarget_Response_result();
}
