...
#include "controller_interfaces/srv/detail/set_target__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const controller_interfaces::srv::SetTarget_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller_interfaces::srv::SetTarget_Request & ros_message)
{
  // Member: target
...
{
  auto typed_message =
    static_cast<const controller_interfaces::srv::SetTarget_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller_interfaces::srv::SetTarget_Request *>(
    untyped_ros_message);
...
{
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interfaces, srv, SetTarget_Request)() {
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_controller_interfaces
cdr_serialize(
  const controller_interfaces::srv::SetTarget_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  controller_interfaces::srv::SetTarget_Response & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const controller_interfaces::srv::SetTarget_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller_interfaces::srv::SetTarget_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interfaces, srv, SetTarget_Response)() {
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget_Response__handle;
}
...
{
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_interfaces, srv, SetTarget)() {
  return &controller_interfaces::srv::typesupport_fastrtps_cpp::_SetTarget__handle;
}
