...
static const _SetTarget_Request_type_support_symbol_names_t _SetTarget_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, SetTarget_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_interfaces, srv, SetTarget_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, controller_interfaces, srv, SetTarget_Request)() {
  return &::controller_interfaces::srv::rosidl_typesupport_c::SetTarget_Request_message_type_support_handle;
}
...
static const _SetTarget_Response_type_support_symbol_names_t _SetTarget_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, SetTarget_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_interfaces, srv, SetTarget_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, controller_interfaces, srv, SetTarget_Response)() {
  return &::controller_interfaces::srv::rosidl_typesupport_c::SetTarget_Response_message_type_support_handle;
}
...
static const _SetTarget_type_support_symbol_names_t _SetTarget_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, SetTarget)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_interfaces, srv, SetTarget)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, controller_interfaces, srv, SetTarget)() {
  return &::controller_interfaces::srv::rosidl_typesupport_c::SetTarget_service_type_support_handle;
}
