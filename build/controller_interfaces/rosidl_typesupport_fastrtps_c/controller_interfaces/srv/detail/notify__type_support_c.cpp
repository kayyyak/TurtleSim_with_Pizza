...
#include "controller_interfaces/srv/detail/notify__rosidl_typesupport_fastrtps_c.h"
...
using _Notify_Request__ros_msg_type = controller_interfaces__srv__Notify_Request;
...
size_t get_serialized_size_controller_interfaces__srv__Notify_Request(
  const void * untyped_ros_message,
...
static uint32_t _Notify_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_interfaces__srv__Notify_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interfaces
size_t max_serialized_size_controller_interfaces__srv__Notify_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Notify_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_interfaces__srv__Notify_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, Notify_Request)() {
...
using _Notify_Response__ros_msg_type = controller_interfaces__srv__Notify_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interfaces
size_t get_serialized_size_controller_interfaces__srv__Notify_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Notify_Response__ros_msg_type * ros_message = static_cast<const _Notify_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_interfaces__srv__Notify_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_interfaces
size_t max_serialized_size_controller_interfaces__srv__Notify_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Notify_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_interfaces__srv__Notify_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, Notify_Response)() {
...
// already included above
// #include "controller_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "controller_interfaces/srv/notify.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_interfaces, srv, Notify)() {
